...
#
# SternFA PCB v1.10 with the Cyclone IV v4 piggy-back board.
# Taken 1:1 from the Stern.qsf of SternFA_HW1.1_Cyclone_IV_v4.
#
# Differs from hw1_1_cyclone_10 in six locations only: SW_Selftest, U10_PA[2],
# U10_PA[4], U11_PA[2], U11_PA[5], U11_PB[1] - and in the pull-up on SW_Selftest,
# which this chip can take and PIN_22 on the Cyclone 10 cannot.
